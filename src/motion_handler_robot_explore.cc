 ...
 * Member Functions
 ******************************************************************************/
void MotionHandlerRobotExplore::UpdateVelocity_Robot(double light_l,
  double light_r, double food_l, double food_r, int hunger) {
    ...
    switch (hunger) {
      case NORMAL:
        speed_left =
          ROBOT_OFFSET_SPEED - ROBOT_OFFSET_SPEED * (light_r / 1000);
        speed_right =
          ROBOT_OFFSET_SPEED - ROBOT_OFFSET_SPEED * (light_l / 1000);
        break;
      case HUNGRY:
        speed_left =
          (ROBOT_OFFSET_SPEED - ROBOT_OFFSET_SPEED * (light_r / 1000))* 0.5;
        speed_right =
          (ROBOT_OFFSET_SPEED - ROBOT_OFFSET_SPEED * (light_l / 1000)) * 0.5;
